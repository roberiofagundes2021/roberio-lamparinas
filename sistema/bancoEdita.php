...
<head>
  ...
  $(document).ready(function() {
    console.log($('#inputBancoNome').val());
              ...
              <div class="row">
                <div class="col-lg-2">
                  <div class="form-group">
                    <label for="inputCodigo">Código do Banco <span class='text-danger'>*</span></label>
                    <input type="text" id="inputCodigo" name="inputCodigo" class="form-control" placeholder="Código" value="<?php echo $row['BancoCodigo']; ?>" maxlength="3" required autofocus>
                  </div>
                </div>
                <div class="col-lg-10">
                  <div class="form-group">
