						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="text-right">
									...
									<a href="servicoExporta.php" style="float:right; margin-left: 5px;" onclick="atualizaServico(0, '', '', 'exportar')" class="btn bg-slate-700 btn-icon" role="button" data-popup="tooltip" data-placement="bottom" data-container="body" title="Exportar Serviços"><i class="icon-drawer-out"></i></a>
