...
<head>
	...
	<script type="text/javascript">
			...
			$('#incluirDadoSocietarios').on('click', function (e) {
				...
				$.ajax({
					...
					success: function(response) {
						...
						//dadoSocietarios()
						$("#dataDadoSocietarios").html(response);						
					}
				});
			})
		...
		function excluirSocio(nome) {
			alert("Passou1");
			/*$.ajax({
				type: 'POST',
				url: 'filtraFornecedorSocio.php',
				data: {
					'tipoRequest': 'EXCLUIRDADOSOCIETARIO',
					'nome' : nome
				},
				success: function(response) {
					alert("Passou2");
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<!-- Info blocks -->
				<?php
					if (isset($_SESSION['fornecedorSocio'])){
						var_dump($_SESSION['fornecedorSocio']);
					} else{
						echo "Limpa";
					} 
				?>
