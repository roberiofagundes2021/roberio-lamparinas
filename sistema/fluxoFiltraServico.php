...
if (isset($_POST['idSubCategoria']) && $_POST['idSubCategoria'] != '#' and $_POST['idSubCategoria'] != ''){
	...
	$sql = "SELECT ServiId, ServiNome, ServiDetalhamento, MarcaNome
			FROM Servico
	...
	$output .= ' <div class="row" style="margin-top: 8px;">
					<div class="col-lg-9">
						<div class="row">
							...
							<div class="col-lg-8">
								<input type="text" id="inputServico'.$cont.'" name="inputServico'.$cont.'" class="form-control-border-off" data-popup="tooltip" title="'. substr($item['ServiDetalhamento'],0,380).'..." value="'.$item['ServiNome'].'" readOnly>
							</div>
							<div class="col-lg-3">
