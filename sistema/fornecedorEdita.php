...
/**
 * Data 23/03/2023
 * Autor:Robério Fagundes dos Santos 
 */
									...
									<div class="row">
										<div class="col-lg-3" id="CPF">
											<div class="form-group">
												...
												placeholder="CPF" data-mask="999.999.999-99" onblur="validaEFormataCpf()"
												 value="<?php echo formatarCPF_Cnpj($row['ForneCpf']); ?>">
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="text" id="inputNacionalidade" name="inputNacionalidade" class="form-control" 
												placeholder="Nacionalidade" value="<?php echo $row['ForneNacionalidade']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-1">
											<div class="form-group">
												<label for="inputAno">Ano &nbsp<i style="color:#375b82;" class="icon-question4" 
												data-popup="tooltip" data-original-title="Entrada no Brasil (se estrangeiro)" data-placement="right"></i></label>
									...
									<div class="row">
										...
										<div class="col-lg-8">
											<div class="form-group">
												...
												<input type="text" id="inputRazaoSocial" name="inputRazaoSocial" class="form-control"
												 placeholder="Razão Social" value="<?php echo $row['ForneRazaoSocial']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-4">
											<div class="form-group">
												...
												<input type="text" id="inputNomeFantasia" name="inputNomeFantasia" class="form-control"
												 placeholder="Nome Fantasia" value="<?php echo $row['ForneNome']; ?>" required autofocus>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="text" id="inputInscricaoMunicipal" name="inputInscricaoMunicipal" class="form-control"
												 placeholder="Inscrição Municipal" value="<?php echo $row['ForneInscricaoMunicipal']; ?>" >
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="text" id="inputInscricaoEstadual" name="inputInscricaoEstadual" class="form-control"
												 placeholder="Ins. Estadual" value="<?php echo $row['ForneInscricaoEstadual']; ?>">
											</div>
										</div>
									</div>
										...
										<div class="col-lg-4">
											<div class="form-group">
												...
												<select id="cmbCategoriaPJ" name="cmbCategoriaPJ" class="form-control select-search">
													<option value="<?php echo $row['ForneCategoria'];?>">
													<?php echo $row['ForneCategoria'];?>
													<h6>e sua categoria escolhida deseja mudar? escolhar abaixo</h6>
												</option>
													<?php
													$sql = "SELECT CategId, CategNome
															FROM Categoria
									...
									<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												...
												<input type="text" id="inputCep" name="inputCep" class="form-control"
												 placeholder="CEP" <?php echo $row['ForneCep'];?> maxLength="8">
											</div>
										</div>
										...
										<div class="col-lg-5">
											<div class="form-group">
												...
												placeholder="Endereço" <?php echo $row['ForneEndereco'];?>>
											</div>
										</div>
										...
										<div class="col-lg-1">
											<div class="form-group">
												...
												<input type="text" id="inputNumero" name="inputNumero" class="form-control"
												 placeholder="Número" <?php echo $row['ForneNumero'];?> maxLength="15">
											</div>
										</div>
										...
										<div class="col-lg-5">
											<div class="form-group">
												...
												<input type="text" id="inputComplemento" name="inputComplemento" class="form-control"
												 placeholder="complemento" <?php echo $row['ForneComplemento'];?>>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-lg-4">
											<div class="form-group">
												...
												<input type="text" id="inputBairro" name="inputBairro" class="form-control"
												 placeholder="Bairro" value="<?php echo $row['ForneBairro']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-5">
											<div class="form-group">
												...
												<input type="text" id="inputCidade" name="inputCidade" class="form-control"
												 placeholder="Cidade" value="<?php echo $row['ForneCidade']; ?>">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="text" id="inputNomeContato" name="inputNomeContato" class="form-control"
												 placeholder="Contato" value="<?php echo $row['ForneContato']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="tel" id="inputTelefoneResidencial" name="inputTelefoneResidencial" class="form-control"
												 placeholder="Telefone Residencial" data-mask="(99) 9999-9999" value="<?php echo $row['ForneTelefone']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="tel" id="inputTelefoneComercial" name="inputTelefoneComercial" class="form-control"
												 placeholder="Telefone Comercial" data-mask="(99) 9999-9999" value="
												 <?php echo $row['ForneTelefoneComercial']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="tel" id="inputCelular" name="inputCelular" class="form-control"
												 placeholder="Celular" data-mask="(99) 99999-9999" value="<?php echo $row['ForneCelular']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="email" id="inputEmail" name="inputEmail" class="form-control"
												 placeholder="E-mail" value="<?php echo $row['ForneEmail']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="url" id="inputSite" name="inputSite" class="form-control"
												 placeholder="URL" value="<?php echo $row['ForneSite']; ?>">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												...
												<textarea rows="5" cols="5" class="form-control" id="txtareaObservacao" name="txtareaObservacao"
												 placeholder="Observação"><?php echo $row['ForneObservacao']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-5">
											...
											<select id="cmbBanco" name="cmbBanco" class="form-control form-control-select2">
												...
												foreach ($rowBanco as $item) {
													...
													print('<option value="' . $item['BancoId'] . '" ' . $seleciona . '>' .
													 $item['BancoCodigo'] . " - " . $item['BancoNome'] . '</option>');
												}
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												placeholder="Agência + dígito" value="<?php echo $row['ForneAgencia']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="text" id="inputConta" name="inputConta" class="form-control"
												 placeholder="Conta + dígito" value="<?php echo $row['ForneConta']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" id="inputInfoAdicional" name="inputInfoAdicional"
												 class="form-control" value="<?php echo $row['ForneInformacaoAdicional']; ?>">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" id="inputIpi" name="inputIpi" class="form-control"
												 placeholder="IPI (%)" value="<?php echo mostraValor($row['ForneIpi']); ?>"
												  onKeyUp="moeda(this)" maxLength="6">
											</div>
										</div>
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" id="inputFrete" name="inputFrete" 
												class="form-control" placeholder="Frete (%)" value="<?php echo mostraValor($row['ForneFrete']); ?>"
												 onKeyUp="moeda(this)" maxLength="6">
											</div>
										</div>
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" id="inputIcms" name="inputIcms" class="form-control"
												 placeholder="ICMS (%)" value="<?php echo mostraValor($row['ForneIcms']); ?>"
												  onKeyUp="moeda(this)" maxLength="6">
											</div>
										</div>
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" id="inputOutros" name="inputOutros" class="form-control"
												 placeholder="Outros (%)" value="<?php echo mostraValor($row['ForneOutros']); ?>" 
												 onKeyUp="moeda(this)" maxLength="6">
											</div>
										</div>
									</div>
