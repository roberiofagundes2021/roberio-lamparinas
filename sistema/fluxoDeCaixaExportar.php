...
$dadosXls .= "     <tr>";
$dadosXls .= "        <td scope='col' bgcolor='#a3a3a3'>Saldo Inicial</td>";
$dadosXls .= "        <td scope='col' bgcolor='#a3a3a3'>0,00</td>"; 
$dadosXls .= "        <td scope='col' bgcolor='#a3a3a3'>0,00</td>";
$dadosXls .= "     </tr>";
...
$dadosXls .= "     <tr>";
$dadosXls .= "        <td scope='col' bgcolor='#a3a3a3'>Frete</td>";
$dadosXls .= "        <td scope='col' bgcolor='#a3a3a3'>0,00</td>"; 
$dadosXls .= "        <td scope='col' bgcolor='#a3a3a3'>0,00</td>";
$dadosXls .= "     </tr>";
...
function retornaBuscaComoArray($datasFiltro, $plFiltro, $grupoPlanoConta, $tipo) {
    ...
    if($tipo == 'E') {
      $sql = "SELECT PlConId, PlConNome,
                    dbo.fnPlanoContasPrevisto(".$_SESSION['UnidadeId'].", PlConCodigo, '".$datasFiltro."', '".$datasFiltro."', '".$tipo."') as PrevistoSaida,
                    dbo.fnPlanoContasRealizado(".$_SESSION['UnidadeId'].", PlConCodigo, '".$datasFiltro."', '".$datasFiltro."', '".$tipo."') as RealizadoSaida
              FROM PlanoConta
...
if($typeFiltro == "D"){
    ...
    $saldoInicial .= "       <tr>";
    $saldoInicial .= "          <td scope='col' bgcolor='#a3a3a3'>Saldo Inicial</td>";

    //Traz os valores do Saldo Final
    $saldoFinal .= "       <tr>";
    $saldoFinal .= "          <td scope='col' bgcolor='#a3a3a3'>Saldo Final</td>";
    ...
    foreach($rowGrupo as $grupo) {
        ...
        $grupoConta .= "     <tr>";
        $grupoConta .= "         <td scope='col' bgcolor='#607D8B'>".$nomeGrupo."</td>";
        ...
        for($i = $diaInicio;$i <= $diaFim;$i++) {
            ...
            if($controlador) {
                ...
                $legenda .= "     <th scope='col' bgcolor='#607D8B'>Previsto</th>";
                $legenda .= "     <th scope='col' bgcolor='#607D8B'>Realizado</th>";

                $saldoInicial .= "<td scope='col' bgcolor='#a3a3a3'>".mostraValor($saldoPrevisto)."</td>";
                $saldoInicial .= "<td scope='col' bgcolor='#a3a3a3'>".mostraValor($saldoRealizado)."</td>";

                $saldoFinal .= "<td colspan='2' bgcolor='#a3a3a3'>&nbsp;&nbsp;".mostraValor($totalSaldoFinal)."&nbsp;</td>";
            }
            
            //Traz os saldos do grupo conta
            $grupoConta .= "    <td scope='col' bgcolor='#607D8B'>".mostraValor($totalPrevisto)."</td>"; 
            $grupoConta .= "    <td scope='col' bgcolor='#607D8B'>".mostraValor($totalRealizado)."</td>";
            ...
            foreach($arrayPlanoContaSintetico as $consultaPlanoContaSintetico){
                ...
                if($contador == 0) {
                    $arrayPlanoContaPrevisto[$indicePlanoConta] = "<td scope='col' bgcolor='#a3a3a3'>".mostraValor($consultaPlanoContaSintetico['PL_Previsto'])."</td>
                                                                   <td scope='col' bgcolor='#a3a3a3'>".mostraValor($consultaPlanoContaSintetico['PL_Realizado'])."</td>";
                }else {
                    $arrayPlanoContaPrevisto[$indicePlanoConta] .= "<td scope='col' bgcolor='#a3a3a3'>".mostraValor($consultaPlanoContaSintetico['PL_Previsto'])."</td>
                                                                    <td scope='col' bgcolor='#a3a3a3'>".mostraValor($consultaPlanoContaSintetico['PL_Realizado'])."</td>";
                }
        ...
        foreach($arrayNomePlanoContaSintetico as $nomePlanoContaSintetico) {
            ...
            $planoContaSintetico .= "    <td scope='col' bgcolor='#a3a3a3'>&nbsp;&nbsp;".$nomePlanoContaSintetico."</td>";
