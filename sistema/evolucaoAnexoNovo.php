...
if(isset($_POST['inputData'])){
	...
	try{	
		...
		if (move_uploaded_file($_FILES['inputArquivo']['tmp_name'], $_UP['pasta'] . $nome_final)) {
            ...
            $sql = "INSERT INTO EnfermagemEvolucaoAnexo (EnEAnData, EnEAnNome, EnEAnArquivo, EnEAnEnfermagemEvolucao, EnEAnUsuarioAtualizador,EnEAnUnidade)
					VALUES (:iData, :sNome, :iArquivo, :iEnfermagemEvolucao, :iUsuarioAtualizador, :iUnidade)";
			...
			$result->execute(array(
							...
							':iArquivo' => $nome_final,
							':iEnfermagemEvolucao' => $_SESSION['idEvolucaoAnexo'],
							...
							<div class="row" style="margin-top: 30px;">
								<div class="col-lg-12">								
									<div class="form-group">
										...
										<a href="evolucaoAnexo.php" class="btn btn-basic" role="button">Cancelar</a>
									</div>
								</div>
							</div>
						</form>								
