...
foreach ($row as $item){
	...
	$output .= ' <div class="row" style="margin-top: 8px;">
									...
									<div class="col-lg-1">
										<input type="text" id="inputQuantidade'.$cont.'"'.($saldo > 0?'':'readOnly').' name="inputQuantidade'.$cont.'" onkeypress="validaQuantInputModal('.$saldo.',this)" class="form-control-border Quantidade" onChange="calculaValorTotal('.$cont.')" onkeypress="return onlynumber();" value="'.$quantidade.'">
									</div>		
									<div class="col-lg-1">
