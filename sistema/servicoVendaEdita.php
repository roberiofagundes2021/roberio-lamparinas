...
if(isset($_POST['inputServicoId'])){
	...
	try{
		...
		$valorCusto = mostraValor($row['SrVenValorCusto']);
		$valorVenda	= mostraValor($row['SrVenValorVenda']);
		$outrasDespesas = mostraValor($row['SrVenOutrasDespesas']);
		$custoFinal = mostraValor($row['SrVenCustoFinal']);
		$margemLucro = mostraValor($row['SrVenMargemLucro']);	
				...
				<div class="card">
					...
					<form id="formServico" name="formServico" method="post" class="form-validate-jquery" action="servicoVendaEdita.php">
						<div class="card-header header-elements-inline">
							<h5 class="text-uppercase font-weight-bold">Editar Serviço "<?php echo $row['SrVenNome']; ?>"</h5>
						</div>
						
						<input type="hidden" id="inputServicoId" name="inputServicoId" value="<?php echo $row['SrVenId']; ?>" >
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" cols="5" class="form-control" id="txtDetalhamento" name="txtDetalhamento" placeholder="Detalhamento do serviço"><?php echo $row['SrVenDetalhamento']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
