			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
						...
						<span><?php echo nomeSobrenome($_SESSION['UsuarNome'],2); ?></span>
					</a>
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<?php
							//Trocar isso para o campo chave da tabela perfil
							if ($_SESSION['PerfiNome'] == 'Super Administrador'){
								print('<a href="gerenciador.php" class="dropdown-item"><i class="icon-cog5"></i> Gerenciador</a>');
							}
						?>
