			...
			$('#salvarPacienteModal').on('click', function(e) {
				...
				switch (menssageError) {
					...
					case $('#nomeMaeNew').val():
						...
						$('#nomeMaeNew').focus();
						break;
						case $('#estadoCivilNew').val():
						menssageError = 'Informe o estado Civil!!';
						$('#estadoCivilNew').focus();
						break;
						case $('#naturalidadeNew').val():
						menssageError = 'Informe a naturalidade!!';
						$('#naturalidadeNew').focus();
						break;
