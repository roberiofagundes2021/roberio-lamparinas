	...
	<script type="text/javascript" >
		...
		function getAtendimentos(){
			...
			$.ajax({
				...
				dataType: 'json',
				data: {
					'tipoRequest': 'ATENDIMENTOSHOSPITALARES',
					'acesso': acessoTipo
				},
				success: function(response) {
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-lg-9">
										<p class="font-size-lg">A relação abaixo faz referência aos atendimentos hospitalares da unidade <b><?php echo $_SESSION['UnidadeNome']; ?></b></p>
									</div>
