...
if(isset($_POST['inputData'])){
	...
	try{	
		...
		if (move_uploaded_file($_FILES['inputArquivo']['tmp_name'], $_UP['pasta'] . $nome_final)) {
			...
			$sql = "INSERT INTO ProfissionalAnexo (PrAneData, PrAneNome, PrAneArquivo, PrAneProfissional, PrAneUsuarioAtualizador,PrAneUnidade)
					VALUES (:iData, :sNome, :iArquivo, :iProfissional, :iUsuarioAtualizador, :iUnidade)";
			...
			$result->execute(array(
							...
							':iArquivo' => $nome_final,
							':iProfissional' => $_SESSION['idProfissional'],
							...
							<div class="row" style="margin-top: 30px;">
								<div class="col-lg-12">								
									<div class="form-group">
										...
										<a href="profissionalAnexo.php" class="btn btn-basic" role="button">Cancelar</a>
									</div>
								</div>
							</div>
						</form>								
