...
try {
	...
	$sql = "UPDATE Fornecedor SET ForneTipo = :sTipo, ForneNome = :sNome, ForneRazaoSocial = :sRazaoSocial, ForneCnpj = :sCnpj, 
				...
				ForneNacionalidade = :sNacionalidade, ForneAno = :sAno, ForneCarteiraTrabalho = :sCarteiraTrabalho, ForneNumSerie = :sNumSerie, ForneNit = :sNit, ForneNire = :sNire,
			    ForneFoto = :sFoto, ForneCep = :sCep, ForneEndereco = :sEndereco, 
