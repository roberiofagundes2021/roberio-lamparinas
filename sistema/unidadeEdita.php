									...
									<div class="row">
										<div class="col-lg-1">
											<div class="form-group">
												...
												<input type="text" id="inputCep" name="inputCep" class="form-control" placeholder="CEP" value="<?php echo $row['UnidaCep']; ?>" maxLength="8">
											</div>
										</div>
										...
										<div class="col-lg-5">
											<div class="form-group">
												...
												<input type="text" id="inputEndereco" name="inputEndereco" class="form-control" placeholder="Endereço" value="<?php echo $row['UnidaEndereco']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-1">
											<div class="form-group">
												...
												<input type="text" id="inputNumero" name="inputNumero" class="form-control" placeholder="Número" value="<?php echo $row['UnidaNumero']; ?>">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-4">
											<div class="form-group">
												...
												<input type="text" id="inputBairro" name="inputBairro" class="form-control" placeholder="Bairro" value="<?php echo $row['UnidaBairro']; ?>">
											</div>
										</div>
										...
										<div class="col-lg-5">
											<div class="form-group">
												...
												<input type="text" id="inputCidade" name="inputCidade" class="form-control" placeholder="Cidade" value="<?php echo $row['UnidaCidade']; ?>">
											</div>
										</div>
