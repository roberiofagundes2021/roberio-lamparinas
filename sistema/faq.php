...
$_SESSION['PaginaAtual'] = 'Suporte - FAQ';
		...
		<div class="content-wrapper">
			...
			<div class="content">
					...
					<div class="col-lg-4">
						<div class="card">
							<div class="card-body text-center">
								...
								<h5 class="card-title">Centro de Apoio</h5>
								...
								<a href="#" class="btn bg-warning-400">Abrir um chamado</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="card">
							<div class="card-body text-center">
								...
								<h5 class="card-title">Artigos e notícias</h5>
								...
								<a href="#" class="btn bg-blue">Lista de artigos</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="text-center mb-3 py-2">
					<h4 class="font-weight-semibold mb-1">Todas as perguntas serão respondidas</h4>
					<span class="text-muted d-block">Am if number no up period regard sudden better. Decisively surrounded all admiration</span>
				</div>
				<!-- /questions title -->
				...
				<div class="d-flex align-items-start flex-column flex-md-row">
					...
					<div class="w-100 overflow-auto order-2 order-md-1">
						...
						<div class="card-group-control card-group-control-right">
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question4">
											<i class="icon-help mr-2 text-slate"></i> Are court tiled cease young built fat?
										</a>
									</h6>
								</div>
								...
								<div id="question4" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: May 9, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 583</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 21</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question5">
											<i class="icon-help mr-2 text-slate"></i> Announcing of invitation principles in?
										</a>
									</h6>
								</div>
								...
								<div id="question5" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: May 6, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 642</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 26</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="font-size-sm text-uppercase font-weight-semibold text-muted pt-2 mb-2">Selling and buying</div>
						<div class="card-group-control card-group-control-right">
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
								...
								<div id="question6" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										...
										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 832</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 32</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question7">
											<i class="icon-help mr-2 text-slate"></i> Her raising and himself pasture believe?
										</a>
									</h6>
								</div>
								...
								<div id="question7" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										...
										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 453</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 30</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question8">
											<i class="icon-help mr-2 text-slate"></i> And total least her two whose great?
										</a>
									</h6>
								</div>
								...
								<div id="question8" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 24, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 735</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 21</li>
										</ul>
									</div>
								</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question9">
											<i class="icon-help mr-2 text-slate"></i> Whatever landlord yourself at by pleasure?
										</a>
									</h6>
								</div>
								...
								<div id="question9" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 22, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 735</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 29</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question10">
											<i class="icon-help mr-2 text-slate"></i> Oh conveying do immediate acuteness?
										</a>
									</h6>
								</div>
								...
								<div id="question10" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 19, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 498</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 12</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="font-size-sm text-uppercase font-weight-semibold text-muted pt-2 mb-2">Intellectual property</div>
						<div class="card-group-control card-group-control-right">
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question12">
											<i class="icon-help mr-2 text-slate"></i> Projection invitation affronting admiration?
										</a>
									</h6>
								</div>
								...
								<div id="question12" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 13, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 735</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 34</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question13">
											<i class="icon-help mr-2 text-slate"></i> It as instrument boisterous frequently?
										</a>
									</h6>
								</div>
								...
								<div id="question13" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 11, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 865</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 43</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question14">
											<i class="icon-help mr-2 text-slate"></i> You fully seems stand nay?
										</a>
									</h6>
								</div>
								...
								<div id="question14" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 10, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 432</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 38</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question15">
											<i class="icon-help mr-2 text-slate"></i> Enjoyment discourse ye continued?
										</a>
									</h6>
								</div>
								...
								<div id="question15" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Apr 9, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 735</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 46</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="font-size-sm text-uppercase font-weight-semibold text-muted pt-2 mb-2">User accounts</div>
						<div class="card-group-control card-group-control-right">
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question17">
											<i class="icon-help mr-2 text-slate"></i> Simple innate summer fat appear?
										</a>
									</h6>
								</div>
								...
								<div id="question17" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Mar 29, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 290</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 29</li>
										</ul>
									</div>
								</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question18">
											<i class="icon-help mr-2 text-slate"></i> Outward clothes promise?
										</a>
									</h6>
								</div>
								...
								<div id="question18" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Mar 24, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 642</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 39</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question19">
											<i class="icon-help mr-2 text-slate"></i> Sufficient particular impossible?
										</a>
									</h6>
								</div>
								...
								<div id="question19" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Mar 17, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 753</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 26</li>
										</ul>
									</div>
								</div>
							...
							<div class="card mb-2">
								<div class="card-header">
									<h6 class="card-title">
										<a class="text-default collapsed" data-toggle="collapse" href="#question20">
											<i class="icon-help mr-2 text-slate"></i> Yet preference connection unpleasant?
										</a>
									</h6>
								</div>
								...
								<div id="question20" class="collapse">
									...
									<div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0">
										<span class="text-muted">Latest update: Mar 12, 2015</span>

										<ul class="list-inline text-nowrap mb-0 ml-auto mt-2 mt-sm-0">
											<li class="list-inline-item"><a href="#" class="text-primary mr-2"><i class="icon-thumbs-up2"></i></a> 589</li>
											<li class="list-inline-item"><a href="#" class="text-muted mr-2"><i class="icon-thumbs-down2"></i></a> 25</li>
										</ul>
									</div>
								</div>
					...
					<div class="sidebar sidebar-light bg-transparent sidebar-component sidebar-component-right border-0 shadow-0 wmin-sm-300 order-1 order-md-2 sidebar-expand-md">
						...
						<div class="sidebar-content">
								...
								<div class="card-header bg-transparent header-elements-inline">
									...
									<div class="header-elements">
										<div class="list-icons">
					                		<a href="#" class="list-icons-item"><i class="icon-help"></i></a>
				                		</div>
			                		</div>
								</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<a href="#" class="btn bg-teal btn-block">Ask question <i class="icon-comment ml-2"></i></a>
								</div>

								<div class="nav nav-sidebar mb-2">
									<li class="nav-item">
										<a href="#" class="nav-link border-0"><i class="icon-lifebuoy"></i> Help center</a>
									</li>
									<li class="nav-item">
										<a href="#" class="nav-link"><i class="icon-book"></i> Knowledgebase</a>
									</li>
									<li class="nav-item">
										<a href="#" class="nav-link">
											...
											<span class="badge badge-danger badge-pill align-self-center ml-auto">390</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="#" class="nav-link"><i class="icon-graduation"></i> Tutorials</a>
									</li>
									<li class="nav-item">
										<a href="#" class="nav-link">
											<span>
											...
											<span class="badge badge-primary badge-pill align-self-center ml-auto">78</span>
										</a>
									</li>
									<li class="nav-item-divider"></li>
									<li class="nav-item">
										<a href="#" class="nav-link"><i class="icon-comment"></i> Ask our community</a>
									</li>
									<li class="nav-item">
										<a href="#" class="nav-link"><i class="icon-mail5"></i> Contact us</a>
									</li>
								</div>
							</div>
							<!-- /navigation -->
				...
				<!-- Latest articles -->
				<div class="text-center mb-3 mt-2 py-2">
