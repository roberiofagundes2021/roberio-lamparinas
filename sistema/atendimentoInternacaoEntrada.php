...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#salvarInternacaoEntrada').on('click', function (e) {
				e.preventDefault();

				let msg = ''
				let sinaisESintomasClinicos = $('#sinaisESintomasClinicos').val()
				let justificativaInternacao = $('#justificativaInternacao').val()
				let resultProvaDiagnostica = $('#resultProvaDiagnostica').val()
				let cid10 = $('#cid10').val()				
				let servico = $('#servico').val()

				switch(msg){
					case sinaisESintomasClinicos: msg = 'Informe o texto dos Sinais e Sintomas!';$('#sinaisESintomasClinicos').focus();break
					case justificativaInternacao: msg = 'Informe o texto da Justificativa de Internação!';$('#justificativaInternacao').focus();break
					case resultProvaDiagnostica: msg = 'Informe o texto do Resultado da Prova Diagnóstica!';$('#resultProvaDiagnostica').focus();break
				...
				$.ajax({
					...
					data: {
						'tipoRequest': 'SALVARINTERNACAOENTRADA',
						'iAtendimentoId' : <?php echo $iAtendimentoId; ?>,
						'profissional' : <?php echo $userId; ?> ,
						'sinaisESintomasClinicos' : sinaisESintomasClinicos,				
						'justificativaInternacao' : justificativaInternacao,				
						'resultProvaDiagnostica' : resultProvaDiagnostica,				
						'cid10' : cid10,						
						'servico' : servico						
					},
			...
			$('#finalizarInternacaoEntrada').on('click', function (e) {
				...
				$.ajax({
					...
					dataType: 'json',
					data: {
						'tipoRequest': 'FINALIZARINTERNACAOENTRADA',
						'iAtendimentoId' : <?php echo $iAtendimentoId; ?>,					
					},
					success: function(response) {
						if(response.status == 'success'){
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-header header-elements-inline" style='margin: auto -10px -25px;'>
								<div class="col-lg-12">
									<div class="alert alert-dark" role="alert">
										<h3 class="card-title">Internação Hospitalar</h3>
									</div>
								</div>
		'					</div>
							...
							<div class="card-header header-elements-inline">
								<div class="col-lg-11">	
									...
									<button type="button" id="prescricao-btn" class="btn-grid btn btn-lg btn-outline-secondary btn-lg mr-2 " onclick="mudarGrid('prescricao')" >Prescrição Médica</button>
								</div>
							</div>
						...
						<div class="box-entradaPaciente" style="display: block;">
							<div class="card">
								...
								<div class="card-header header-elements-inline">
									<h3 class="card-title">JUSTIFICATIVA DA INTERNAÇÃO</h3>
								</div>
								...
								<div class="card-body">
									...
									<form id="formDieta" name="formDieta" method="post" class="form-validate-jquery">									
										<div class="row" style="margin-top: 10px">
											<div class="col-lg-12">
												<div class="form-group">
													<label for="justificativa">Principais Sinais e Sintomas Clínicos <span class="text-danger">*</span></label>
													<textarea rows="5" cols="5" maxLength="470" id="sinaisESintomasClinicos" name="sinaisESintomasClinicos" onInput="contarCaracteres(this);" class="form-control" placeholder="Informe o texto dos Sinais e Sintomas." ></textarea>
													<small class="text-muted form-text">Max. 470 caracteres - <span class="caracteresjustificativa"></span></small>
												</div>
											</div>
										</div>
										...
										<div class="row" style="margin-top: 10px">
											<div class="col-lg-12">
												<div class="form-group">
													<label for="justificativa">Condições que justificam a internação <span class="text-danger">*</span></label>
													<textarea rows="4" cols="4" maxLength="350" id="justificativaInternacao" name="justificativaInternacao" onInput="contarCaracteres(this);" class="form-control" placeholder="Informe o texto da Justificativa de Internação." ></textarea>
													<small class="text-muted form-text">Max. 350 caracteres - <span class="caracteresjustificativa"></span></small>
												</div>
											</div>
										</div>
										...
										<div class="row" style="margin-top: 10px">
											<div class="col-lg-12">
												<div class="form-group">
													<label for="justificativa">Principais resultados de provas diagnósticas <span class="text-danger">*</span></label>
													<textarea rows="4" cols="4" maxLength="350" id="resultProvaDiagnostica" name="resultProvaDiagnostica" onInput="contarCaracteres(this);" class="form-control" placeholder="Informe o texto do Resultado da Prova Diagnóstica." ></textarea>
													<small class="text-muted form-text">Max. 350 caracteres - <span class="caracteresjustificativa"></span></small>
												</div>
											</div>
										</div>
						...
						<div class="box-prescricao" style="display: none;">
                            ...
                            <div class="col-md-12">
                                <div class="row">                                    
                                    <div class="col-md-10" style="text-align: left;">
                                        <button type="button" class="btn btn-lg btn-success mr-1" id="salvarInternacaoEntrada">Salvar</button>
                                        <button type="button" class="btn btn-lg btn-secondary mr-1">Imprimir</button>
                                    </div>
                                    
                                    <div class="col-md-2" style="text-align: right;">
                                        <button type="button" class="btn btn-lg btn-secondary mr-1" id="finalizarInternacaoEntrada">Finalizar Atendimento</button>
                                    </div>
                                </div>
                            </div> 
                        </div>
