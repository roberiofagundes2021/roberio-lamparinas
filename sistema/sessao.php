...
$arquivosEmpresa = array(
	...
	'localEstoqueExclui.php', 'localEstoqueValida.php', 'localEstoqueMudaSituacao.php', 'usuarioLotacao.php', 'usuarioLotacaoNovo.php',
	'usuarioLotacaoValida.php', 'usuarioLotacaoExclui.php'
);
