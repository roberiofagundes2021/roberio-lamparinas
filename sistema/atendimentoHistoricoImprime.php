...
try {
	...
	$html .= '
        <table style="width:100%; border-collapse: collapse;"> 
            <tr>
                <td colspan="1" style="width:25%; font-size:12px;">Prontuário Eletrônico:<br>'.$row['ClienCodigo'].'</td>	
                <td colspan="1" style="width:25%; font-size:12px;">Nº do Registro:<br>'.$row['AtendNumRegistro'].'</td>
                <td colspan="1" style="width:25%; font-size:12px;">Modalidade:<br>'.$row['AtModNome'].'</td>
                <td colspan="1" style="width:25%; font-size:12px;">CNS:<br>'.$row['ClienCartaoSus'].'</td>
            </tr>
        </table>
        <table style="width:100%; border-collapse: collapse;"> 
            <tr>
    ...
    if($row['AtClaChave'] == "AMBULATORIAL"){
        ...
        $html .= '
            ...
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">Queixa Principal (QP)</td>	
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbQueixaPrincipal'].'</td>
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">História da Moléstia Atual (HMA)</td>
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbHistoriaMolestiaAtual'].'</td>	
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;">
                <tr >
                    <td colspan="1" style="width:20%; font-weight: bold;">Exame Físico</td>
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbExameFisico'].'</td>	
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">Suspeita Diagnóstico</td>	
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbSuspeitaDiagnostico'].'</td>
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">Exame Solicitado</td>
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbExameSolicitado'].'</td>	
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;">
                <tr >
                    <td colspan="1" style="width:20%; font-weight: bold;">Prescrição</td>
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbPrescricao'].'</td>	   
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">Outras Observações</td>	
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtAmbOutrasObservacoes'].'</td>
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">Receituário</td>
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtRecReceituario'].'</td>	
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;">
                <tr >
                    <td colspan="1" style="width:20%; font-weight: bold;">Solicitação de Procedimento</td>
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtSExSolicitacaoExame'].'</td>	
        ...
        $html .= '
            ...
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
                    <td colspan="1" style="width:20%; font-weight: bold;">Clínica (anamnese)</td>	
                    <td colspan="1" style="width:80%; font-size:12px;">'.$row['AtEleAnamnese'].'</td>
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse;"> 
                <tr>
